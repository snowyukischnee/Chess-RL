...
from CP_CHESS.agents.a2c_agent_exp.board2state import Board2State0 as board2state
...
class ChessEnvWrapper(object):
    def __init__(self, name: str):
        self.env = ChessEnv()
        # self.opponent = Model(None, None, gpu_idx=None, scope=Model.GLOBAL_SCOPE + name, global_net=None)
        self.opponent = None
